    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 space-y-6 overflow-x-hidden">
      ...
      <div className="space-y-4">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-200/80 pb-3">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-rose-100 text-rose-800 text-xs font-black rounded-full border border-rose-200 mb-1">
              <MapPin className="w-3.5 h-3.5 text-rose-600" />
              <span>Emergency Location Grid</span>
            </div>
          ...
          <div className="flex items-center gap-2 overflow-x-auto pb-1 scrollbar-none">
            <a
              href="tel:108"
              className="px-3.5 py-2 bg-rose-600 hover:bg-rose-700 text-white font-extrabold text-xs rounded-xl shadow-md flex items-center gap-1.5 shrink-0 transition-transform active:scale-95"
            >
            ...
            <a
              href="tel:100"
              className="px-3.5 py-2 bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs rounded-xl shadow-md flex items-center gap-1.5 shrink-0 transition-transform active:scale-95"
            >
            ...
            <a
              href="tel:101"
              className="px-3.5 py-2 bg-amber-600 hover:bg-amber-700 text-white font-extrabold text-xs rounded-xl shadow-md flex items-center gap-1.5 shrink-0 transition-transform active:scale-95"
            >
      ...
      <section className="space-y-4 pt-2 border-t border-slate-200/80">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <h2 className="text-xs font-black uppercase tracking-wider text-slate-400">
            Emergency Resources & Fleets (Tap to expand)
          </h2>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Ambulance className="w-4 h-4" />
              <span>Verified Ambulances ({ambulances.length})</span>
              {activeSection === "ambulances" ? <ChevronUp className="w-3.5 h-3.5" /> : <ChevronDown className="w-3.5 h-3.5" />}
            </button>
            ...
            >
              ...
              {activeSection === "hotlines" ? <ChevronUp className="w-3.5 h-3.5" /> : <ChevronDown className="w-3.5 h-3.5" />}
            </button>
            ...
            >
              ...
              <span>Checklist</span>
              {activeSection === "checklist" ? <ChevronUp className="w-3.5 h-3.5" /> : <ChevronDown className="w-3.5 h-3.5" />}
            </button>
          </div>
        </div>
